...
public class EndScreen : MonoBehaviour
{
	...
	void Start ()
	{
		...
		string strg = PlayerPrefs.GetString ("Result");

		switch (strg) {
		case "rich": 
			img.sprite = Resources.Load ("ending/rich", typeof(Sprite)) as Sprite;
		...
		case "adventure":
			img.sprite = Resources.Load ("ending/adventure", typeof(Sprite)) as Sprite;
			...
			break;
		case "family":
			img.sprite = Resources.Load ("ending/family", typeof(Sprite)) as Sprite;
