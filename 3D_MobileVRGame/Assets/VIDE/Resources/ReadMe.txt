The dialogues you create with the VIDE Editor will be stored inside the Dialogues folder. These files contain all of the data required for your interface to work. 
